...
def fill_country():
    ...
    # COUNTRY LIST WITH NAME AND CODE
    countries = [
    ...
    for i in range(len(countries)):
        # GET ID
        id = "C" + str(random.randint(1000, 9999))

        # CHECK WHETHER ID IS ALREADY ASSIGNED
        while id in ids:
            id = "C" + str(random.randint(1000, 9999))
        ids.append(id)

        # GET THE NAME OF THE COUNTRY FROM LIST
        name = countries[i]["name"]

        # HEADERS FOR GOOGLE SEARCH
        headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36'}
        url = 'https://www.google.com/search?q=' + name + '&ie=utf-8&oe=utf-8&num=10'
        ...
        # GET THE COUTRY FLAG FROM FLAGCDN.COM AS A HTML IMAGE TAG
        image = "<img src='https://flagcdn.com/256x192/" + \
            countries[i]["code"].lower() + \
            ".png' width='64' height='48' alt='" + name + "'>"
        ...
        try:
            ...
            print(name + " is inserted. " + str(i+1) +
                  " of " + str(len(countries)) + " completed.")

        except:
            "Error occured when commiting " + name + " - " + str(i)
    ...
    # PRINT ELAPSED TIME
    print("Time Elapsed: " + str((end - start)/60) + " mts")
